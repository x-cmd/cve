...
_101,552 CVEs across 666 distinct CWEs since 2024._
...
| ---: | :-: | :--- | ---: | ---:      |
| 1 | [79](https://cwe.mitre.org/data/definitions/79.html) | Improper Neutralization of Input During Web Page Generation ('Cross-site Scripting') | 16,083 | 6.15 |
...
| ---: | ---: | ---:   | ---:      | ---:      |
| 2026 _(YTD as of 2026-07-24)_ | 36,437 | 34,676 | 7.01 | 10.0 |
...
| **Total** | **352,284** | **179,522** | **6.82** | **10.0** |
<!-- END cve.report.md -->
