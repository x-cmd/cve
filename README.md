...
_104,871 CVEs across 669 distinct CWEs since 2024._
...
| 4 | [74](https://cwe.mitre.org/data/definitions/74.html) | Improper Neutralization of Special Elements in Output Used by a Downstream Component ('Injection') | 4,050 | 7.02 |
| 5 | [352](https://cwe.mitre.org/data/definitions/352.html) | Cross-Site Request Forgery (CSRF) | 3,152 | 5.79 |
| 6 | [22](https://cwe.mitre.org/data/definitions/22.html) | Improper Limitation of a Pathname to a Restricted Directory ('Path Traversal') | 2,893 | 7.18 |
...
| ---: | ---: | ---:   | ---:      | ---:      |
| 2026 _(YTD as of 2026-08-08)_ | 40,485 | 38,551 | 7.03 | 10.0 |
...
| **Total** | **356,445** | **186,185** | **6.85** | **10.0** |
<!-- END cve.report.md -->
