...
_112,249 CVEs across 678 distinct CWEs since 2024._
...
| 6 | [22](https://cwe.mitre.org/data/definitions/22.html) | Improper Limitation of a Pathname to a Restricted Directory ('Path Traversal') | 3,181 | 7.18 |
...
| ---: | ---: | ---:   | ---:      | ---:      |
| 2026 _(YTD as of 2026-08-28)_ | 50,170 | 47,378 | 7.08 | 10.0 |
...
| **Total** | **366,258** | **195,232** | **6.87** | **10.0** |
<!-- END cve.report.md -->
