...
_103,225 CVEs across 667 distinct CWEs since 2024._
...
| 2 | [89](https://cwe.mitre.org/data/definitions/89.html) | Improper Neutralization of Special Elements used in an SQL Command ('SQL Injection') | 7,216 | 7.44 |
| 3 | [862](https://cwe.mitre.org/data/definitions/862.html) | Missing Authorization | 5,552 | 5.87 |
...
| ---: | ---: | ---:   | ---:      | ---:      |
| 2026 _(YTD as of 2026-08-03)_ | 38,866 | 36,882 | 7.02 | 10.0 |
| 2025 | 43,283 | 41,843 | 6.79 | 10.0 |
...
| **Total** | **354,782** | **182,730** | **6.83** | **10.0** |
<!-- END cve.report.md -->
