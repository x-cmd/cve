...
**数据截至：2026-09-02** _（每日从上游 cvelistV5 更新 —— 明天再看，榜单就会有变化）。_
<!-- cve-data-as-of:END -->
...
自 2024 年以来，共 113,365 个 CVE，涉及 680 个不同的 CWE。
...
| ---: | :-: | :--- | ---: | ---:      |
| 1 | [79](https://cwe.mitre.org/data/definitions/79.html) | Improper Neutralization of Input During Web Page Generation ('Cross-site Scripting') | 16,883 | 6.17 |
...
| ---: | ---: | ---:   | ---:      | ---:      |
| 2026 _（截至 2026-09-02）_ | 51,449 | 48,855 | 7.08 | 10.0 |
...
| **Total** | **367,560** | **196,739** | **6.87** | **10.0** |
<!-- END cve.report.md -->
