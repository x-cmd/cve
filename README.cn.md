...
**数据截至：2026-09-12** _（每日从上游 cvelistV5 更新 —— 明天再看，榜单就会有变化）。_
<!-- cve-data-as-of:END -->
...
自 2024 年以来，共 117,446 个 CVE，涉及 683 个不同的 CWE。
...
| 4 | [502](https://cwe.mitre.org/data/definitions/502.html) | Deserialization of Untrusted Data | 1,745 | 8.34 | 10.0 |
...
| ---: | ---: | ---:   | ---:      | ---:      |
| 2026 _（截至 2026-09-12）_ | 56,070 | 52,849 | 7.08 | 10.0 |
...
| **Total** | **372,244** | **200,794** | **6.87** | **10.0** |
<!-- END cve.report.md -->
