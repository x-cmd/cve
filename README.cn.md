...
自 2024 年以来，共 114,631 个 CVE，涉及 682 个不同的 CWE。
...
| 3 | [862](https://cwe.mitre.org/data/definitions/862.html) | Missing Authorization | 6,191 | 5.96 |
...
| 4 | [502](https://cwe.mitre.org/data/definitions/502.html) | Deserialization of Untrusted Data | 1,721 | 8.33 | 10.0 |
...
| ---: | ---: | ---:   | ---:      | ---:      |
| 2026 _（截至 2026-09-07）_ | 52,788 | 50,007 | 7.08 | 10.0 |
...
| **Total** | **368,934** | **197,922** | **6.87** | **10.0** |
<!-- END cve.report.md -->
