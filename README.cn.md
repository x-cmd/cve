...
**数据截至：2026-09-09** _（每日从上游 cvelistV5 更新 —— 明天再看，榜单就会有变化）。_
<!-- cve-data-as-of:END -->
...
自 2024 年以来，共 116,364 个 CVE，涉及 683 个不同的 CWE。
...
| ---: | :-: | :--- | ---: | ---:      |
| 1 | [79](https://cwe.mitre.org/data/definitions/79.html) | Improper Neutralization of Input During Web Page Generation ('Cross-site Scripting') | 17,127 | 6.17 |
| 2 | [89](https://cwe.mitre.org/data/definitions/89.html) | Improper Neutralization of Special Elements used in an SQL Command ('SQL Injection') | 7,709 | 7.45 |
| 3 | [862](https://cwe.mitre.org/data/definitions/862.html) | Missing Authorization | 6,243 | 5.97 |
| 4 | [74](https://cwe.mitre.org/data/definitions/74.html) | Improper Neutralization of Special Elements in Output Used by a Downstream Component ('Injection') | 4,288 | 7.02 |
| 5 | [22](https://cwe.mitre.org/data/definitions/22.html) | Improper Limitation of a Pathname to a Restricted Directory ('Path Traversal') | 3,284 | 7.18 |
| 6 | [352](https://cwe.mitre.org/data/definitions/352.html) | Cross-Site Request Forgery (CSRF) | 3,257 | 5.80 |
| 7 | [94](https://cwe.mitre.org/data/definitions/94.html) | Improper Control of Generation of Code ('Code Injection') | 2,775 | 6.78 |
| 8 | [416](https://cwe.mitre.org/data/definitions/416.html) | Use After Free | 2,520 | 7.66 |
| 9 | [78](https://cwe.mitre.org/data/definitions/78.html) | Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection') | 2,490 | 8.10 |
| 10 | [125](https://cwe.mitre.org/data/definitions/125.html) | Out-of-bounds Read | 2,293 | 6.34 |
...
| 2 | [95](https://cwe.mitre.org/data/definitions/95.html) | Improper Neutralization of Directives in Dynamically Evaluated Code ('Eval Injection') | 135 | 8.55 | 10.0 |
...
| 4 | [502](https://cwe.mitre.org/data/definitions/502.html) | Deserialization of Untrusted Data | 1,736 | 8.33 | 10.0 |
| 5 | [288](https://cwe.mitre.org/data/definitions/288.html) | Authentication Bypass Using an Alternate Path or Channel | 459 | 8.28 | 10.0 |
...
| 8 | [603](https://cwe.mitre.org/data/definitions/603.html) | Use of Client-Side Authentication | 17 | 8.15 | 9.8 |
| 9 | [121](https://cwe.mitre.org/data/definitions/121.html) | Stack-based Buffer Overflow | 1,820 | 8.13 | 10.0 |
| 10 | [120](https://cwe.mitre.org/data/definitions/120.html) | Buffer Copy without Checking Size of Input ('Classic Buffer Overflow') | 1,114 | 8.12 | 10.0 |
<!-- END cwe.report.md -->
...
| ---: | ---: | ---:   | ---:      | ---:      |
| 2026 _（截至 2026-09-09）_ | 54,796 | 51,677 | 7.09 | 10.0 |
| 2025 | 43,463 | 42,034 | 6.79 | 10.0 |
| 2024 | 38,444 | 37,045 | 6.81 | 10.0 |
| 2023 | 30,609 | 24,732 | 6.73 | 10.0 |
| 2022 | 26,444 | 17,467 | 6.79 | 10.0 |
...
| **Total** | **370,952** | **199,603** | **6.87** | **10.0** |
<!-- END cve.report.md -->
