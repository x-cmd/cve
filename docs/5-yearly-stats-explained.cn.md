...
翻倍间隔在缩短：2018 → 2023（5 年）几乎翻倍（16k → 30k），2023 → 2026（3 年）按节奏会到 2.5×。2024 → 2026 只用两年就翻倍。
...
所以 2014 年的 93% 缺口来自两大保留区间（Microsoft 100k 和 Apple 120k），各只填了 1–2%。CNA 体系 2020 年前后成熟后，缺口稳定在 38–53%，来自以下因素的组合：
