---
x-title: Using the data
x-desc: Three ways to consume the CVE / CWE data — curl + xz on raw TSVs, x cve shell module, and DuckDB / pandas.
x-sidebar: Using the data
x-keywords: curl CVE database, xz TSV, x cve shell module, DuckDB CVE, pandas CVE
x-json-ld:
